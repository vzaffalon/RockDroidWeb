...
angular.module('RockDroid.pages').factory('UtmConverter', function ($http, $q, ApiEndpoint) {
  ...
  UtmConverter.toLatLon = function(easting, northing, zoneNum, zoneLetter, northern, strict) {
  ...
  UtmConverter.fromLatLon = function(latitude, longitude, forceZoneNum) {
